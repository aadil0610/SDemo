...
import com.isme.shen.slibrary.utils.GeometryUtil;
import com.isme.shen.slibrary.utils.ValueUtil;
import com.isme.shen.slibrary.utils.WindowUtils;
...
public class GooView extends View {
	...
	private float mStaicRadius = 12f;// 直径
	private float mMoveCircleCenter = 70f;
	private float mMoveRadius = 15f;// 直径

	// 最大移动距离
	private float mMaxDistance = 120f;

	public float getmStaicCircleCenter() {
		return mStaicCircleCenter;
	}

	public void setmStaicCircleCenter(float mStaicCircleCenter) {
		this.mStaicCircleCenter = mStaicCircleCenter;
	}

	public float getmStaicRadius() {
		return mStaicRadius;
	}

	public void setmStaicRadius(float mStaicRadius) {
		this.mStaicRadius = mStaicRadius;
	}

	public float getmMoveCircleCenter() {
		return mMoveCircleCenter;
	}

	public void setmMoveCircleCenter(float mMoveCircleCenter) {
		this.mMoveCircleCenter = mMoveCircleCenter;
	}

	public float getmMoveRadius() {
		return mMoveRadius;
	}

	public void setmMoveRadius(float mMoveRadius) {
		this.mMoveRadius = mMoveRadius;
	}

	public float getmMaxDistance() {
		return mMaxDistance;
	}

	public void setmMaxDistance(float mMaxDistance) {
	...
	protected void onSizeChanged(int w, int h, int oldw, int oldh) {
		...
		mBarHeight = WindowUtils.getStatusBarHeight(this);
	}
...
//					isDisappear = true;
//					invalidate();
					updateMoveCenter(event.getX(),event.getY());
					setmMoveCircleCenter(event.getX());
					mStaticCenter.set(event.getX(),event.getY());
				}else {
