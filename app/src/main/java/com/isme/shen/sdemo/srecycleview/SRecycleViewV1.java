...
import com.isme.shen.sdemo.SplashActivity;
...
public class SRecycleViewV1 extends AppCompatActivity {
    ...
    private void initData() {
        ...
        SRecycleViewV1.this.startActivity(new Intent(SRecycleViewV1.this,SplashActivity.class));
            ...
            public void refresh() {
                new Thread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        SRecycleViewV1.this.runOnUiThread(new Runnable() {
                            @Override
                            public void run() {
        ...
        public void onBindViewHolder(RecyclerView.ViewHolder holder, final int position) {
            ...
            tv.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View view) {
                    Toast.makeText(SRecycleViewV1.this,"position:"+position,Toast.LENGTH_SHORT).show();
                }
            });
        }
